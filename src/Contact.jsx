  ...
  return (
    ...
    <div className="contactForm flex flex-col md:flex-row md:mt-32 justify-center md:justify-normal">
      <div className="md:w-1/2 mx-4 md:mx-40  md:mt-20 " id='contact' >
        <h2 className="font-space sm:mt-14 md:text-8xl leading-88 text-center md:text-left text-4xl font-bold leading-40 tracking-tight mt-14 md:mt-0">Contact</h2>
      ...
      <div className="flex flex-col mx-4 md:w-1/2  mt-12 md:mx-40  md:mt-20">
        ...
        className=''>
          <div className="mb-8">
            <input type="text" placeholder="NAME" name='name' className="text-base text-white font-medium leading-6 tracking-tight font-space opacity-50 h-11 w-full " required />
            <hr className='md:mr-32 w-full ' />
          </div>
          <div className="mb-8">
            <input type="text" placeholder="EMAIL" name='email' className="text-base font-medium  text-white leading-6 tracking-tight font-space opacity-50 h-11 w-full" required />
            <hr className='md:mr-32 w-full'/>
          </div>
          <div className="mb-8">
            <textarea type="text" placeholder="MESSAGE" name='message' className="text-base text-white font-medium leading-6 tracking-tight font-space opacity-50 w-full " required />
            <hr className='md:mr-32 w-full' />
          </div>
