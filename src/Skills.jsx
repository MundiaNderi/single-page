...
export default function Skills() {
    return (
        <div className="skills md:mx-44 flex flex-col mt-16">
            <hr className='' />
            ...
            <div className="access flex flex-col gap-6 justify-between md:mt-14 md:flex-row" >
                <div>
                    <h2 className="text-white font-space md:text-3xl md:leading-14 tracking-tight text-center md:text-left font-SpaceGrotesk font-bold text-2xl leading-10 mt-6" >Accessibility</h2>
                    <p className="font-medium  font-space text-base leading-7 text-center md:text-left" >1 Year Experience</p>
                 </div>
                 <div>
                ...
                <div>
                    <h2 className="text-white font-space md:text-3xl md:leading-14 tracking-tight text-center md:text-left font-SpaceGrotesk font-bold text-2xl leading-10" >Sass</h2>
                    <p className="font-medium  font-space text-base leading-7 text-center md:text-left" >1 Year Experience</p>
                </div>
            </div>
        </div>
